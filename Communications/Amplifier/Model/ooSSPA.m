function [voltage_out coefficient_set_1 VP_1 coefficient_set_2 VP_2]=ooSSPA(voltage_in,coefficient_set_1,coefficient_set_2)
...
switch n_coefficient_set_1
    ...
    case 1
        VP_1=[voltage_in];
    case 2
        VP_1=voltage_in.*[1;(abs(voltage_in)^2)];
    case 3
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4)];
    case 4
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4);(abs(voltage_in)^6)];
    case 5
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4);(abs(voltage_in)^6);...
            (abs(voltage_in)^8)];
    case 6
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4);(abs(voltage_in)^6);...
            (abs(voltage_in)^8);(abs(voltage_in)^10)];
    case 7
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4);(abs(voltage_in)^6);...
            (abs(voltage_in)^8);(abs(voltage_in)^10);...
    ...
    case 8
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4);(abs(voltage_in)^6);...
            (abs(voltage_in)^8);(abs(voltage_in)^10);...
			(abs(voltage_in)^12);(abs(voltage_in)^14)];
    case 9
        VP_1=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4);(abs(voltage_in)^6);...
            (abs(voltage_in)^8);(abs(voltage_in)^10);...
...
switch n_coefficient_set_2
    ...
    case 1
        VP_2=[voltage_in];
    case 2
        VP_2=voltage_in.*[1;(abs(voltage_in)^2)];
    case 3
        VP_2=voltage_in.*[1;(abs(voltage_in)^2);...
            (abs(voltage_in)^4)];
    case 4
