function [errors]=Write_and_Update_LTC2656_X16(Master_Object,BASE_ADDRESS,CHANNEL_NUMBER,value)
...
if status_register(6) & status_register(7)
    Master_Object.write('uint32',sprintf('0x%08X',hex2dec(BASE_ADDRESS)+4),hex2dec('00300000')+hex2dec(write_data)+hex2dec(value));
else
